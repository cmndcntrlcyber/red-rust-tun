...
async fn main() -> std::io::Result<()> {
    ...
    let client_ca = load_client_ca("client_ca.pem")?;
    ...
    // Wrap the config in an Arc and create a TLS acceptor.
    ...
    loop {
        ...
        tokio::spawn(async move {
            ...
            // Split the stream and create a buffered reader.
            ...
            loop {
                tokio::select! {
                    ...
                    result = rx.recv() => {
                        ...
                        // Avoid echoing back to the same client.
                        if addr != other_addr {
